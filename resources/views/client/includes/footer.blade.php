...
<footer id="nt_footer" class="">
    <div style="background-color:#f6f6f8" id="shopify-section-footer_top" class="">
        <div class="">
            <div class="container ">
                <div style="padding-top: 90px;
    padding-bottom: 90px;" class="row">
                    <div class="col-lg-3 col-md-6 col-12 ">
                        <aside id="block_1581507819652" class="">
                            <h3 style="font-size: 17px;
    padding-bottom: 34px;" class="">
    ...
    padding-bottom: 34px;" class=""><span class="">Customer Care</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <aside id="block_1581507828337" class="">
                            <h3 style="font-size: 17px;
    ...
    <div id="shopify-section-footer_bot" style="background-color:white; padding:25px" class="">
        <div class="">
            <div class="container ">
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-12 col_1">Copyright © 2021 <span class="cp">Sapphire</span> all rights reserved.</div>
                    <div style="text-align: right;" class="col-lg-6 col-md-12 col-12 col_2">
                        <div class=""><img class="" src="//cdn.shopify.com/s/files/1/1592/0041/files/22_77d5e291-487e-4af6-9469-cad4afcc7d02.png?v=1612344652" data-src="" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
...
<script src="public/clientassets/zoom-image.js"></script>
    <script src="public/clientassets/main.js"></script>
</body>
